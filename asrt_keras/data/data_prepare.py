...
if __name__ == "__main__":
    ...
    parser.add_argument("--thchs30", type=str, help="where to load thchs source and correction file")
    parser.add_argument("--aishell", type=str, help="where to load aishell source and correction file")
